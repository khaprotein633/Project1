...
const ProductDetailPage = () => {
  ...
  // Get the image URL based on the selected size and color
  const [productImage, setProductImage] = useState(product?.main_image);
  ...
  useEffect(() => {
    if (product?.inventory) {
      ...
      setProductImage(product?.main_image); // Set the main image initially
  ...
  const handleSizeClick = (size) => {
    ...
    // Reset product image when size changes
  ...
  const filterInventory = (size, color) => {
    ...
    // Update product image based on the selected size and color combination
    setProductImage(filtered[0]?.image_url);
  };
              ...
              <div className="details-section">
                ...
                <div className="details-item">
                  ...
                  >
                    ...
                    {/* <p>A beautifully crafted product made with high-quality materials. Perfect for your needs.</p> */}
                  </div>
                </div>
